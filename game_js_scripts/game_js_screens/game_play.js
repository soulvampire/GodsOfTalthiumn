    ...
    {	
      ...
      /*********************/
    	...
    	/******************************/
    		...
    		/****************************/
				this.floating_map_panel = new game.generic_floating_panel_interface(null, this.defined_screen_width - 110, 5, 105, 138, "map_interface", this.is_floating, this.is_persistent, this.is_moveable);
